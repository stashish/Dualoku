🧩 Sudoku Solver A web-based Sudoku Solver & Generator built with React. This app allows users to play, generate, and solve Sudoku puzzles of different grid sizes (4x4, 6x6, 9x9).
